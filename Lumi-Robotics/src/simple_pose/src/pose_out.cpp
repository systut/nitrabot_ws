...
std::string getFilenameWithTime()
{
    ...
    auto output_s = "/home/ubuntu/Lumi-Robotics/src/simple_pose/log/pose_data_" + s + ".csv"; 
    //std::string output_s="/home/ubuntu/Lumi-Robotics/src/simple_pose/log/poseData_out.csv"; 
