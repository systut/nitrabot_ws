    ...
    heading_(0)
{
    ...
    ros::Subscriber cartographer_subscriber_ = nh_.subscribe("tracked_pose", 50, &RikiBase::velCallback, this);
...
void RikiBase::cartographerCallback(const geometry_msgs::PoseStamped& pose)
{
    ...
    geometry_msgs::Quaternion odom_quat = pose.pose.orientation;
