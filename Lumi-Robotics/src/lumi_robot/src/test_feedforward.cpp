...
class TestFeedForwardControl 
{
    private:
        ...
        void readReference()
        {
            ...
            std::ifstream ref_file("/home/syseng402/Straight.csv");
            if (ref_file.good())
            {
                ...
                --num_ref_points;
                ref_ = Eigen::MatrixXd(2, num_ref_points);
        ...
        void execute(const ros::TimerEvent& event)
        {
            ...
            Eigen::Vector2d input_ref = ref_.block(0, counter_, 2, 1);
    ...
    public:
        TestFeedForwardControl(ros::NodeHandle nh)
        {
            ...
            controller_timer_ = nh_.createTimer(ros::Duration(0.1), &TestFeedForwardControl::execute, this);
